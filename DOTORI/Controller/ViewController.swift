...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //더미데이터들
        data[0].nickname = "im_pigeon"
        data[0].content = "9999999999999999999999999999999"
        data[0].profileImage = UIImage(named: "pigeon.png")
        data[0].contentImage = UIImage(named: "pigeon.png")
        data[1].nickname = "im_lion"
        data[1].profileImage = UIImage(named: "pigeon.png")
        ...
        data[2].nickname = "DotoriMook"
        data[2].profileImage = UIImage(named: "dotori.png")
...
extension ViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.profile_image.image = data[indexPath.row].profileImage
        cell.profile_nickname.text = data[indexPath.row].nickname
        return cell
    }
