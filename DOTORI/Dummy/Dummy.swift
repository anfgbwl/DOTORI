...
var posting2 = PostingInfo(user: user2, category: "잡담", content: "게시물 삭제 드디어 성공했습니다용~!!", createTime: Date(), updateTime: Date(), contentImage: UIImage(named: "pigeon"), bookmark: false, bookmarkCount: 0, reply: [reply1, reply4, reply2, reply3], tilUrl: "")
var posting3 = PostingInfo(user: user3, category: "질문", content: "오늘 저녁 뭐먹을까요?", createTime: Date(), updateTime: Date(), contentImage: UIImage(named: "defaultProfileImage"), bookmark: false, bookmarkCount: 0, reply: [reply3, reply2, reply4, reply2], tilUrl: "")
var posting4 = PostingInfo(user: user3, category: "고양이방", content: "나만 고양이 없어어어", createTime: Date(), updateTime: Date(), contentImage: UIImage(named: "cat"), bookmark: false, bookmarkCount: 0, reply: [reply3, reply2, reply4, reply2], tilUrl: "")
...
var posting7 = PostingInfo(user: user1, category: "잡담", content: "오늘 축구한판 뛰고 오겠습니다.", createTime: Date(), updateTime: Date(), contentImage: UIImage(named: "image2"), bookmark: false, bookmarkCount: 0, reply: [reply1, reply4, reply2, reply2], tilUrl: "")
